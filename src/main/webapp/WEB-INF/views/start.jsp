...
<head>
    ...
    <title>Sharing something with us!</title>
...
<div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
    ...
    <jsp:include page="blocks/startpage/header.jsp" />
    ...
    <main class="px-3">
        ...
        <p class="lead">
            <a href="/dashboard" class="btn btn-lg btn-light fw-bold border-white bg-white">Go to dashboard</a>
        </p>
    </main>

    <jsp:include page="blocks/startpage/footer.jsp"/>
</div>
